...
def draw(model_F, model_L, model_D, source_test_loader, target_test_loader, device, need_exten_channel1, need_exten_channel2):
    source_imgs_list = []
    target_imgs_list = []
    source_label_list = []
    target_label_list = []
...
def main():
    ...
    load_checkpoint('mix3/F-94.pth', model_F, 111)
    load_checkpoint('mix3/L-94.pth', model_L, 111)
    load_checkpoint('mix3/D-94.pth', model_D, 111)
    
    #dataset init and loader warper
    source_test_set = dannLoader.DIGIT('hw3_data/digits/svhn/test', 'hw3_data/digits/svhn/test.csv', transforms.ToTensor())
    ...
    draw(model_F, model_L, model_D, test_loader1, test_loader2, device, False, True)
